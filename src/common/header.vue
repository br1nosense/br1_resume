        ...
        <div class="w-box">
          <div class="nav-logo">
            <h1 @click="changePage(-1)">
              <router-link to="/" title="Omo简历">Omo简历</router-link>
            </h1>
          </div>
          <div class="right-box">
            <div class="nav-list">
              <el-autocomplete
                placeholder="需要什么简历模板？"
                icon="search"
                v-model="input"
                minlength="1"
                maxlength="100"
              ...
              ></el-autocomplete>
              <router-link to="/resumeshow">
                <a @click="changePage(2)">全部简历</a>
              </router-link>
                <router-link to="/login">
                <a @click="changePage(3)">登录</a>
              </router-link>
            </div>
                ...
                <div class="nav-user-wrapper pa" v-if="login">
                  <div class="nav-user-list">
                    <ul>
                      ...
                      <li>
                        <router-link to="/user/orderList">我的简历</router-link>
                      </li>
                      <li>
                        <router-link to="/user/information">会员信息</router-link>
                      </li>
                      <li>
                        <router-link to="/user/addressList">升级vip</router-link>
                      </li>
                      <li>
                        <router-link to="/user/support">我的订单</router-link>
                      </li>
                      <li>
